...
local travelNode = keywordHandler:addKeyword({"isle of strife"}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "Do you want to sail to Isle of Strife " .. (getConfigInfo("freeTravel") and "free?" or "50 gps?")})
	travelNode:addChildKeyword({"yes"}, StdModule.travel, {npcHandler = npcHandler, premium = false, level = 0, cost = 0, destination = {x=33100, y=31018, z=7} })
	travelNode:addChildKeyword({"no"}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, reset = true, text = "We would like to serve you some time."})
...
keywordHandler:addKeyword({"travel"}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "Where do you want to go {Chazorai}, {Isle of Strife} or {Back}."})
keywordHandler:addKeyword({"go"}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "Where do you want to go {Chazorai}, {Isle of Strife} or {Back}."})
