...
-- the function add_depot_item(guid, item, count) as made by magus from ######	 ####
...
2, --	 1º -	 - when player add an offer, his offer will stay for X days, in this case 2.	 # O #
{"gold coin", "crystal coin", "platinum coin", "worm"}, --	 2º -	 - put here all items that you dont want players put for sale.	 # S #
{able_runes = false, able_potions = true}, --	 3º -	 - choose if you want to player sell runes/pots	 # E #
40000000, --	 4º -	 - max offer that players may ask for his item's, in this case 40 000 000 golds (40kk).	 # J #
5, --	 5º -	 - max items that each player can put for sale, in this case 5.	 # R # 
'houseItems.txt', --	 6º -	 <###MAIN FILE###> - this is the name of the MAIN FILE, where the script save the offers..	 # 2 #
2160, --	 7º -	 - this show a crystal coin (itemid: 2160) when player say ex: !auction-list [param # 3 #
3 --	 8º -	 - this is the access You need to use command !auction-clean	 ####	
--################################################## ################################################## ######################
...
local offers = get_player_offers(getPlayerGUID(getPlayerByName(pa ram)), main_file)
...
doPlayerSendCancel(cid, 'not a valid command>')
return false	
end	
if not (param) then
